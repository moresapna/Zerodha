      ...
      <div className="container">
        <div className="row mt-4">
          <div className="col-3">
            ...
            <div>
              <i className="fa-brands fa-x-twitter fa-xl me-3"></i>
              <i className="fa-brands fa-square-facebook fa-xl me-3"></i>
              <i className="fa-brands fa-instagram fa-xl me-3"></i>
              <i className="fa-brands fa-linkedin-in fa-xl me-3"></i>
            </div>
            <hr></hr>
            <div className="mr-3 mb-4">
              <i className="fa-brands fa-youtube fa-xl me-3"></i>
              <i className="fa-brands fa-whatsapp fa-xl me-3"></i>
              <i className="fa-brands fa-telegram fa-xl me-3"></i>
            </div>
            <div>
              <img
